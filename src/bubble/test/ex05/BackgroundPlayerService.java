...
//			Color leftColor2 = new Color(image.getRGB(player.getX() + 10, player.getY() + 25));
			Color rightColor = new Color(image.getRGB(player.getX() + 50 + 10, player.getY() + 25));
			Color downColor = new Color(image.getRGB(player.getX(), player.getY() + 50));

//			boolean dw = (downColor.getRed() == 255 && downColor.getGreen() == 255 && downColor.getBlue() == 255);
//			boolean le = (downColor.getRed() == 255 && downColor.getGreen() == 0 && downColor.getBlue() == 0);
			
//			while (player.getY() < 535 && dw) {
...
//					player.setDown(true);
//				}
//			} else if (player.getY() < 535 && dw && player.isUp()==false && !le) {
//				player.down();
//				try {
//					Thread.sleep(100);
//				} catch (InterruptedException e) {
